<?php // Script 9.1  No extra spaces must exist before the PHP tag or the cookie will not be sent!!!!!

// Handle the form if it has been submited:
    if (isset($_POST['font_size'], $_POST['font_color'])) {

        // Send the cookies:
        setcookie('font_size', $_POST['font_size'], time()+10000000, '/', '', 0);                 //Page 254. 
                                                                                                
        setcookie('font_color', $_POST['font_color'], time()+10000000, '/', '', 0);               //Page 254.

        // Message to be printed later:
        $msg = '<p>Your settings have been entered! Now see them <a href="view_settings.php">in action</a>.</p>'; // End of submit if.
    }
?>
<!doctype html>
<html lang="en">
